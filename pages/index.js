      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-slate-200 mt-2">
            Professional Admin & Technician Workflow
          </p>
        </div>
        <div className="grid sm:grid-cols-2 gap-4">
          <Link
            href={{ pathname: "/login", query: { role: "admin" } }}
            className="rounded-2xl bg-white/10 hover:bg-white/20 p-6 backdrop-blur border border-white/10 transition"
          >
            <h2 className="text-2xl font-semibold mb-2">Admin Login</h2>
            <p>Manage technicians, forward calls, reports & payments.</p>
          </Link>
          <Link
            href={{ pathname: "/login", query: { role: "technician" } }}
            className="rounded-2xl bg-white/10 hover:bg-white/20 p-6 backdrop-blur border border-white/10 transition"
          >
